...
public class HbmBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(final @NotNull HolderLookup.Provider provider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(HbmBlocks.CREATIVE_ENERGY_SOURCE.get(), HbmBlocks.MACHINE_BATTERY.get(), HbmBlocks.GEIGER.get(), HbmBlocks.PRESS_PREHEATER.get(), HbmBlocks.BARREL_PLASTIC.get(), HbmBlocks.BARREL_CORRODED.get(), HbmBlocks.BARREL_IRON.get(), HbmBlocks.BARREL_STEEL.get(), HbmBlocks.BARREL_TCALLOY.get(), HbmBlocks.BARREL_ANTIMATTER.get(), HbmBlocks.RED_CABLE.get(), HbmBlocks.RED_CABLE_CLASSIC.get(), HbmBlocks.FLUID_DUCT_NEO.get(), HbmBlocks.ANVIL_IRON.get(), HbmBlocks.ANVIL_LEAD.get(),
        ...
        tag(BlockTags.NEEDS_STONE_TOOL).add(HbmBlocks.CREATIVE_ENERGY_SOURCE.get(), HbmBlocks.MACHINE_BATTERY.get(), HbmBlocks.PRESS_PREHEATER.get(), HbmBlocks.BARREL_PLASTIC.get(), HbmBlocks.BARREL_CORRODED.get(), HbmBlocks.BARREL_IRON.get(), HbmBlocks.BARREL_STEEL.get(), HbmBlocks.BARREL_TCALLOY.get(), HbmBlocks.BARREL_ANTIMATTER.get(), HbmBlocks.RED_CABLE.get(), HbmBlocks.RED_CABLE_CLASSIC.get(), HbmBlocks.FLUID_DUCT_NEO.get(), HbmBlocks.ANVIL_IRON.get(), HbmBlocks.ANVIL_LEAD.get(), HbmBlocks.ANVIL_STEEL.get(),
