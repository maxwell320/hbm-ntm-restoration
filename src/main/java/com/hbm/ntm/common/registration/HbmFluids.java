...
public final class HbmFluids {
    ...
    public static final FluidEntry OXYGEN = registerContainedFluid("oxygen", 0xFF98BDF9, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 3, 0, 0, FluidHazardSymbol.CRYOGENIC));
    public static final FluidEntry XENON = registerContainedFluid("xenon", 0xFFBA45E8, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 0, 0, 0, FluidHazardSymbol.ASPHYXIANT));
    public static final FluidEntry HELIUM3 = registerContainedFluid("helium3", 0xFFFCF0C4, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 0, 0, 0, FluidHazardSymbol.ASPHYXIANT));
    public static final FluidEntry CRYOGEL = registerContainedFluid("cryogel", 0xFF32FFFF, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 2, 0, 0, FluidHazardSymbol.CRYOGENIC));
    public static final FluidEntry CARBONDIOXIDE = registerContainedFluid("carbondioxide", 0xFF404040, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 3, 0, 0, FluidHazardSymbol.ASPHYXIANT));
    public static final FluidEntry HEAVYWATER = registerContainedFluid("heavywater", 0xFF00A0B0, HYDROGEN_STILL, HYDROGEN_FLOWING);
    public static final FluidEntry HEAVYWATER_HOT = registerContainedFluid("heavywater_hot", 0xFF4D007B, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 0, false, 1, 0, 0, FluidHazardSymbol.NONE));
    public static final FluidEntry SODIUM = registerContainedFluid("sodium", 0xFFCCD4D5, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 0, false, 1, 2, 3, FluidHazardSymbol.NONE));
    public static final FluidEntry SODIUM_HOT = registerContainedFluid("sodium_hot", 0xFFE2ADC1, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 0, false, 1, 2, 3, FluidHazardSymbol.NONE));
    public static final FluidEntry THORIUM_SALT = registerContainedFluid("thorium_salt", 0xFF7A5542, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 65, false, 2, 0, 3, FluidHazardSymbol.NONE));
    public static final FluidEntry THORIUM_SALT_HOT = registerContainedFluid("thorium_salt_hot", 0xFF3E3627, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 65, false, 2, 0, 3, FluidHazardSymbol.NONE));
    public static final FluidEntry THORIUM_SALT_DEPLETED = registerContainedFluid("thorium_salt_depleted", 0xFF302D1C, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 65, false, 2, 0, 3, FluidHazardSymbol.NONE));
    public static final FluidEntry CHLORINE = registerContainedFluid("chlorine", 0xFFBAB572, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 25, false, 3, 0, 0, FluidHazardSymbol.OXIDIZER));
    public static final FluidEntry REDMUD = registerContainedFluid("redmud", 0xFFD85638, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 60, false, 3, 0, 4, FluidHazardSymbol.NONE));
    public static final FluidEntry SCHRABIDIC = registerContainedFluid("schrabidic", 0xFF006B6B, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 75, false, 5, 0, 5, FluidHazardSymbol.ACID));
    ...
    public static final FluidEntry FULLERENE = registerContainedFluid("fullerene", 0xFFFF7FED, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 65, false, 3, 3, 3, FluidHazardSymbol.NONE));
    ...
    public static final FluidEntry RADIOSOLVENT = registerContainedFluid("radiosolvent", 0xFFA4D7DD, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 50, false, 3, 3, 0, FluidHazardSymbol.NONE));
    public static final FluidEntry SOURGAS = registerContainedFluid("sourgas", 0xFFC9BE0D, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 10, false, 4, 4, 0, FluidHazardSymbol.ACID));
    public static final FluidEntry REFORMGAS = registerContainedFluid("reformgas", 0xFF6362AE, HYDROGEN_STILL, HYDROGEN_FLOWING);
    public static final FluidEntry PHOSGENE = registerContainedFluid("phosgene", 0xFFCFC4A4, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 4, 0, 1, FluidHazardSymbol.NONE));
    public static final FluidEntry MUSTARDGAS = registerContainedFluid("mustardgas", 0xFFBAB572, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 4, 1, 1, FluidHazardSymbol.NONE));
    ...
    public static final FluidEntry AIR = registerContainedFluid("air", 0xFFE7EAEB, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 0, 0, 0, FluidHazardSymbol.NONE));
    ...
    public static final FluidEntry FRACKSOL = registerContainedFluid("fracksol", 0xFF798A6B, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 15, false, 1, 3, 3, FluidHazardSymbol.ACID));
    public static final FluidEntry PAIN = registerContainedFluid("pain", 0xFF938541, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 30, false, 2, 0, 1, FluidHazardSymbol.ACID));
    public static final FluidEntry DEATH = registerContainedFluid("death", 0xFF717A88, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 80, false, 2, 0, 1, FluidHazardSymbol.ACID));
    public static final FluidEntry WATZ = registerContainedFluid("watz", 0xFF86653E, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 60, false, 4, 0, 3, FluidHazardSymbol.ACID));
    ...
    public static final FluidEntry AMAT = registerContainedFluid("amat", 0xFF010101, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, true, 5, 0, 5, FluidHazardSymbol.ANTIMATTER));
    public static final FluidEntry ASCHRAB = registerContainedFluid("aschrab", 0xFFB50000, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, true, 5, 0, 5, FluidHazardSymbol.ANTIMATTER));
    ...
    public static final FluidEntry BALEFIRE = registerContainedFluid("balefire", 0xFF28E02E, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(true, 50, false, 4, 4, 3, FluidHazardSymbol.RADIATION));
    ...
    public static final FluidEntry NITRIC_ACID = registerContainedFluid("nitric_acid", 0xFFAD6A0E, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 60, false, 3, 0, 2, FluidHazardSymbol.OXIDIZER));
    public static final FluidEntry SULFURIC_ACID = registerContainedFluid("sulfuric_acid", 0xFFB0AA64, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 50, false, 3, 0, 2, FluidHazardSymbol.ACID));
    public static final FluidEntry PEROXIDE = registerContainedFluid("peroxide", 0xFFFFF7AA, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 40, false, 3, 0, 3, FluidHazardSymbol.OXIDIZER));
    public static final FluidEntry SOLVENT = registerContainedFluid("solvent", 0xFFE4E3EF, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 30, false, 2, 3, 0, FluidHazardSymbol.NONE));
    public static final FluidEntry HELIUM4 = registerContainedFluid("helium4", 0xFFE54B0A, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 0, 0, 0, FluidHazardSymbol.ASPHYXIANT));
    public static final FluidEntry PERFLUOROMETHYL = registerContainedFluid("perfluoromethyl", 0xFFBDC8DC, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 1, 0, 1, FluidHazardSymbol.NONE));
    public static final FluidEntry PERFLUOROMETHYL_COLD = registerContainedFluid("perfluoromethyl_cold", 0xFF99DADE, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 1, 0, 1, FluidHazardSymbol.CRYOGENIC));
    public static final FluidEntry PERFLUOROMETHYL_HOT = registerContainedFluid("perfluoromethyl_hot", 0xFFB899DE, HYDROGEN_STILL, HYDROGEN_FLOWING, new FluidHazardProperties(false, 0, false, 1, 0, 1, FluidHazardSymbol.NONE));
